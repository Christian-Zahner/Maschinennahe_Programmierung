...
Sources/UE02A_strings_c.obj: ../Sources/UE02A_strings.c
	@echo 'Building file: $<'
	@echo 'Executing target #4 $<'
	@echo 'Invoking: ColdFire Compiler'
	"$(CF_ToolsDirEnv)/mwccmcf" @@"Sources/UE02A_strings.args" -o "Sources/UE02A_strings_c.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/UE07A_bitrev_c.obj: ../Sources/UE07A_bitrev.c
	@echo 'Building file: $<'
	@echo 'Executing target #9 $<'
	@echo 'Invoking: ColdFire Compiler'
	"$(CF_ToolsDirEnv)/mwccmcf" @@"Sources/UE07A_bitrev.args" -o "Sources/UE07A_bitrev_c.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
...
Sources/UE08_liste_c.obj: ../Sources/UE08_liste.c
	@echo 'Building file: $<'
	@echo 'Executing target #11 $<'
	@echo 'Invoking: ColdFire Compiler'
	"$(CF_ToolsDirEnv)/mwccmcf" @@"Sources/UE08_liste.args" -o "Sources/UE08_liste_c.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
