...
Sources/UE06_trap_c.obj: ../Sources/UE06_trap.c
	@echo 'Building file: $<'
	@echo 'Executing target #8 $<'
	@echo 'Invoking: ColdFire Compiler'
	"$(CF_ToolsDirEnv)/mwccmcf" @@"Sources/UE06_trap.args" -o "Sources/UE06_trap_c.obj" "$<" -MD -gccdep
	@echo 'Finished building: $<'
	@echo ' '
